...
public class SearchReusltAdapter extends BaseRecyclerAdapter<SearchPlayerResult> implements View.OnClickListener{
    private Context mContext;
    private User mUser;
    private List<Player> players;
    public  SearchReusltAdapter(Context context){
    ...
    @Override
    public void onBind(RecyclerView.ViewHolder viewHolder, int realPosition, SearchPlayerResult data) {
